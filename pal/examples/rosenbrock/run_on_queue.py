...
def run(name, sffx, scaled=False, loose=False, very_loose=False, use_MAP=False, upper=1.0, run_standard_misokg=False, run_unitary=False, use_miso=False):
...
run("rosen_bu", "bunit", run_unitary=True)

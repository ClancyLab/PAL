...
def run_bonilla(run_index, sffx, unitary=None):
    ...
    ###################################################################################################
    # File names
    sim.fname_out = "enthalpy_%s.dat" % sffx
    ...
    sim.obj_vs_cost_fname = "data_dumps/%d_%s.dat" % (run_index, sffx)
    sim.mu_fname = "data_dumps/%d_mu_%s.dat" % (run_index, sffx)
    sim.sig_fname = "data_dumps/%d_sig_%s.dat" % (run_index, sffx)
    sim.combos_fname = "data_dumps/%d_combos_%s.dat" % (run_index, sffx)
    sim.hp_fname = "data_dumps/%d_hp_%s.dat" % (run_index, sffx)
    sim.acquisition_fname = "data_dumps/%d_acq_%s.dat" % (run_index, sffx)

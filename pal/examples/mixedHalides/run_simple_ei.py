...
def run_ei(run_index):
    ...
    sim.logger_fname = "data_dumps/%d_ei.log" % run_index
    if os.path.exists(sim.logger_fname):
        os.system("rm %s" % sim.logger_fname)
    os.system("touch %s" % sim.logger_fname)

    sim.obj_vs_cost_fname = "data_dumps/%d_ei.dat" % run_index
    sim.mu_fname = "data_dumps/%d_mu_ei.dat" % run_index
    sim.sig_fname = "data_dumps/%d_sig_ei.dat" % run_index
    sim.sample_fname = "data_dumps/%d_sample_ei.dat" % run_index
    sim.combos_fname = "data_dumps/%d_combos_ei.dat" % run_index
    sim.hp_fname = "data_dumps/%d_hp_ei.dat" % run_index
